...
const connectKitTheme = {
  ...
  "--ck-primary-button-background":
    "linear-gradient(90deg, rgba(82, 219, 255, 0.9), rgba(118, 55, 254, 0.9), rgba(255, 61, 220, 0.9))",
  "--ck-primary-button-hover-background":
    "linear-gradient(90deg, #52DBFF, #7637FE, #FF3DDC)",
  ...
  "--ck-wallet-button-background":
    "linear-gradient(90deg, rgba(82, 219, 255, 0.1), rgba(118, 55, 254, 0.1), rgba(255, 61, 220, 0.1))",
  "--ck-wallet-button-hover-background":
    "linear-gradient(90deg, rgba(82, 219, 255, 0.2), rgba(118, 55, 254, 0.2), rgba(255, 61, 220, 0.2))",
  ...
  "--ck-graphic-primary-background":
    "linear-gradient(135deg, #52DBFF15, #7637FE15, #FF3DDC15)",
  ...
  "--ck-connectbutton-balance-hover-border":
    "1px solid rgba(82, 219, 255, 0.2)",
} as const;
