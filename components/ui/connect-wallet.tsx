          ...
          <div className="bg-zinc-900 rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.3)] ring-1 ring-white/10">
            <div className="flex flex-col items-center justify-center w-full py-8 px-8 gap-4">
              ...
              <div className="flex flex-col items-center gap-2">
                <h3 className="font-orbitron text-xl uppercase text-transparent bg-clip-text tracking-[0.15em] text-center whitespace-nowrap"
                    style={{
                      backgroundImage: 'linear-gradient(to right, rgba(255, 255, 255, 0.95), rgba(255, 255, 255, 0.8))'
                    }}>
