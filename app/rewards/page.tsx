  ...
  const rewardSections = [
    {
      ...
      icon: ScrollText,
      title: "Scores",
      description: "See and submit your previous scores on-chain to receive tickets"
    },
    {
    ...
    },
    {
      ...
      icon: Package,
      title: "Crates",
      description: "Redeem your tickets for crates filled with NFTs from your favourite artist"
    },
    {
      href: "/rewards/vault",
      icon: Vault,
      title: "Vault",
      description: "View your collected items including your tickets, crates, and revealed art"
    }
  ];
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-12">
          ...
          <div className="max-w-2xl">
            <Paragraph className="font-system">
              Track your progress, manage your rewards, and unlock exclusive NFTs.
            </Paragraph>
          </div>
        </div>
                ...
                >
                  ...
                  <div className="absolute inset-3 bg-zinc-900 rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.3)] ring-1 ring-white/10">
                    <div className="flex flex-col items-center justify-center h-full w-full p-6 gap-4">
                      ...
                      <h3 className="font-orbitron text-3xl uppercase text-transparent bg-clip-text bg-gradient-to-r tracking-[0.2em]" 
                          style={{
