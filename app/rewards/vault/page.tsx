...
const MARKETPLACE_LINKS = [
  {
    ...
    logo: "/logos/opensea_logo.svg",
  },
  {
    name: "Magic Eden",
    href: "https://magiceden.io",
    logo: "/logos/magiceden_logo.svg",
  },
  {
    name: "Etherscan",
    href: "https://etherscan.io",
    logo: "/logos/etherscan_logo.svg",
  },
  {
    name: "Arweave",
    href: "https://arweave.org",
    logo: "/logos/arweave_logo.svg",
  },
];
    ...
    <div className="flex flex-col space-y-2">
      ...
      >
        ...
        <div className="max-w-2xl">
          <Paragraph className="">
            View and manage your earned NFTs from playing games and redeeming
            crates.
          </Paragraph>
        </div>
      </motion.div>
      ...
      >
        {EXAMPLE_NFTS.map((nft, index) => (
          ...
          >
            {/* NFT Container */}
            <div
              className="artcade-container-vertical group relative"
            ...
            <div className="artcade-container-vertical group relative h-[200px]">
              ...
              <div className="absolute inset-3 bg-zinc-900 rounded-2xl shadow-[0_0_15px_rgba(0,0,0,0.3)] ring-1 ring-white/10">
                <div className="flex flex-col h-full w-full p-4">
                  ...
                  {/* Token Standard */}
                  <div className="mb-4">
                    <span className="inline-flex items-center rounded-full bg-artcade-purple px-2 py-0.5 text-[10px]  text-white uppercase tracking-wider">
                      {nft.tokenStandard}
                    </span>
                  </div>
